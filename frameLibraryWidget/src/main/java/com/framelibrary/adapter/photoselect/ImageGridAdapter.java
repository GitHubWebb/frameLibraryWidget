package com.framelibrary.adapter.photoselect;
...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (type == TYPE_CAMERA) {
            view = mInflater.inflate(R.layout.fl_list_item_camera, viewGroup,
                    false);
            view.setTag(null);
        } else if (type == TYPE_NORMAL) {
            ViewHolder holder;
            if (view == null) {
                view = mInflater.inflate(R.layout.fl_list_item_image, viewGroup,
                        false);
                ...
                if (holder == null) {
                    view = mInflater.inflate(R.layout.fl_list_item_image,
                            viewGroup, false);
                    holder = new ViewHolder(view);
                }
            }
        ...
        void bindData(final Image data) {
            ...
            if (showSelectIndicator) {
                ...
                if (mSelectedImages.contains(data)) {
                    // 设置选中状态
                    indicator.setImageResource(R.mipmap.fl_btn_selected);
                    mask.setVisibility(View.VISIBLE);
                } else {
                    // 未选择
                    indicator.setImageResource(R.mipmap.fl_btn_unselected);
