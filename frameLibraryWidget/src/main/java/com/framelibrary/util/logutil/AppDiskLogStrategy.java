 ...
 */
public class AppDiskLogStrategy extends DiskLogStrategy {
    public static final int MAX_BYTES = 500 * 1024; // 500K averages to a 4000 lines per file

    @NonNull
    private final Handler handler;

    public AppDiskLogStrategy(@NonNull Handler handler) {
        super(handler);
    ...
    public static class WriteHandler extends Handler {
        ...
        public WriteHandler(@NonNull Looper looper, @NonNull String folder, int maxFileSize) {
            ...
            this.maxFileSize = maxFileSize == 0 ? MAX_BYTES : maxFileSize;
        }
