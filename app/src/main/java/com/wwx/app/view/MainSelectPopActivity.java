...
import com.wwx.app.bean.CardBean;
import com.wwx.app.bean.ProvinceBean;
import com.wwx.app.view.selectpop.FragmentTestActivity;
import com.wwx.app.view.selectpop.JsonDataActivity;
import com.wwx.app.view.selectpop.TestCircleWheelViewActivity;
...
public class MainSelectPopActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_select_pop);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_Time && pvTime != null) {
            ...
            startActivity(new Intent(MainSelectPopActivity.this, JsonDataActivity.class));
        } else if (v.getId() == R.id.btn_fragment) {//跳转到 fragment
            startActivity(new Intent(MainSelectPopActivity.this, FragmentTestActivity.class));
        } else if (v.getId() == R.id.btn_lunar) {
            pvCustomLunar.show();
        } else if (v.getId() == R.id.btn_circle) {
            startActivity(new Intent(MainSelectPopActivity.this, TestCircleWheelViewActivity.class));
        }
    }
    ...
    private void initLunarPicker() {
        ...
        pvCustomLunar = new TimePickerBuilder(this, new OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {//选中事件回调
                Toast.makeText(MainSelectPopActivity.this, getTime(date), Toast.LENGTH_SHORT).show();
            }
        })
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                .setOptionsSelectChangeListener(new OnOptionsSelectChangeListener() {
                    ...
                    public void onOptionsSelectChanged(int options1, int options2, int options3) {
                        ...
                        Toast.makeText(MainSelectPopActivity.this, str, Toast.LENGTH_SHORT).show();
                    }
                })
                .build();
